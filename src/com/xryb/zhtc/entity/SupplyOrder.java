...
public class SupplyOrder implements Serializable{
	...
	@TableField(isNotNull=true,fieldSize=2,comment="订单状态：0-待付款，1-已付款，未发货，2-已发货，未签收，3-已签收，未评价，交易完成，4-已评价，-1-交易取消，-2-超时关闭，-3-待退款，-4-同意退款，-5驳回退款，-6待退货，-7同意退货，-8驳回退货，-9买家已退货，待卖家收货，默认值为0")
	...
	@TableField(fieldSize=5000, comment="买家退货时上传的凭证图片")
	private String sendGoodImg;
	...
	@TableField(fieldSize=30,comment="卖家同意退货时间")
	private String agreeRefundGTime;
	
	@TableField(fieldSize=30,comment="买家退货发货时间")
	private String buyerSendTime;
	
	@TableField(fieldSize=30,comment="卖家同意退款时间")
	private String agreeRefundKTime;
	...
	public String getBuyerSendTime() {
		return buyerSendTime;
	}

	public void setBuyerSendTime(String buyerSendTime) {
		this.buyerSendTime = buyerSendTime;
	}

	public String getSendGoodImg() {
		return sendGoodImg;
	}

	public void setSendGoodImg(String sendGoodImg) {
		this.sendGoodImg = sendGoodImg;
	}
	...
	public String getAgreeRefundGTime() {
		return agreeRefundGTime;
	}

	public void setAgreeRefundGTime(String agreeRefundGTime) {
		this.agreeRefundGTime = agreeRefundGTime;
	}

	public String getAgreeRefundKTime() {
		return agreeRefundKTime;
	}

	public void setAgreeRefundKTime(String agreeRefundKTime) {
		this.agreeRefundKTime = agreeRefundKTime;
	}
