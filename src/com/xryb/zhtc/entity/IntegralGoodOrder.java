 ...
 * @author zzf
 */
@Table(tableName="integral_good_order")
public class IntegralGoodOrder {
	...
	@TableField(comment="商品积分总价")
	private Integer integration;
	
	@TableField(comment="用户剩余积分")
	private Integer userIntegration;
	
	@TableField(comment=" 商品领取时间限制，单位小时，整数")
	private Integer getTime;
	
	@TableField(isNotNull=true,fieldSize=32,comment="兑换店铺的UUID")
	private String entityUUID;
	
	@TableField(isNotNull=true,fieldSize=128,comment="兑换店铺的名称")
	private String entityName;
	
	@TableField(fieldSize=1000,comment="兑换店铺的图片")
