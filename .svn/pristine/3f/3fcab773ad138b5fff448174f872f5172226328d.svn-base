...
public class PinyinUtil {
	...
	public static String getPinYin(String src) {
		...
		char[] t1 = null;//创建字符数组
		t1 = src.toCharArray();//将字符串转换为字符数组
	...
	public static String converterToFirstSpell(String chines) {
		if(chines==null || "".equals(chines) || "null".equals(chines)){
			return "";
		}
		String pinyinName = "";
	...
	public static void main(String[] args) {
		System.out.println(PinyinUtil.converterToFirstSpell("黄仕忠"));//首字母
		System.out.println(PinyinUtil.getPinYin("黄仕忠"));//全拼
	}
