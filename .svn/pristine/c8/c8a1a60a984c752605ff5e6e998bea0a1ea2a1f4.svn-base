...
<form id="sj_form" method="post">
	<input type="hidden" value="<%=vipUUID %>" name="vipUUID" id="vipUUID">
	...
	<table data-options="fit:true" style="width:100%;margin-top: 5px;border-collapse: separate;border-spacing: 5px;">
		...
		<!-- <tr>
			<td align="right">
				<label class="heading">付费入驻:</label>
			</td>
			<td>
				<input type="radio" name="money" value="0">一周体验版￥98(7天)</input>&nbsp;&nbsp;
				<input type="radio" name="money" value="1">短期半年版￥598(185天)</input>&nbsp;&nbsp;
				<input type="radio" name="money" value="2">全年特惠版￥1999(365天)</input>
			</td>
		</tr> -->
		<tr>
			<td align="right">
			...
			<td style="display: none;" id="res">
				<a href="#" onclick="res()" class='easyui-linkbutton' iconcls='icon-undo' data-options="iconCls:'icon-add'">返回</a>
			</td>
		</tr>
	</table>
</form>
