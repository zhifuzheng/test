...
<table id="jb_table" class="easyui-datagrid">
	<thead>
		<tr>
			...
			<th data-options="field:'commodityTitle',align:'center',width:200">需求标题</th>
			<th data-options="field:'demandImg',align:'center',width:100, formatter:demandImg">需求图片</th>
...
<script type="text/javascript">
	...
	//需求图片
	function demandImg(value, row, index){
		var img = path+row.demandImg;
